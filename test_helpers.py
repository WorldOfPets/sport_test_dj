...
def create_sportfriend_News(**kwargs):
    ...
    if "liked_user_list" not in kwargs:
        defaults["liked_user_list"] = create_User()
    defaults.update(**kwargs)
...
def create_sportfriend_UserInfo(**kwargs):
    ...
    if "user_disliked_list" not in kwargs:
        defaults["user_disliked_list"] = create_User()
    if "user_id" not in kwargs:
        defaults["user_id"] = create_User()
    ...
    if "user_liked_list" not in kwargs:
        defaults["user_liked_list"] = create_User()
    defaults.update(**kwargs)
