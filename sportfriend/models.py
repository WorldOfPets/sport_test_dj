...
class SportFriends(models.Model):
    ...
    # Relationships
    user_fr_id = models.ForeignKey("auth.User", related_name="user_fr_set", on_delete=models.CASCADE)
    user_id = models.ForeignKey("auth.User", related_name="user_set", on_delete=models.CASCADE)
